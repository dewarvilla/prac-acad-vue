        ...
        <div class="flex flex-col md:flex-row gap-8">
            <div class="md:w-1/2">
                <div class="card flex flex-col gap-4">
                    <div class="font-semibold text-xl">Formulario de Creación de Prácticas Académicas</div>
                    <div class="flex flex-col gap-2">
                        <label for="name1">Nombre de Práctica Académica</label>
                        <InputText id="name1" type="text" />
                        <small>Este Campo es Requerido.</small>
                    </div>
                    <div class="flex flex-wrap gap-2 w-full">
                        <label for="state">Nivel Académico</label>
                        <Select id="state" v-model="dropdownItem" :options="dropdownItems" optionLabel="name" placeholder="Nivel Académico" class="w-full"></Select>
                        <small>Este Campo es Requerido.</small>
                    </div>
                    <div class="flex flex-col gap-2">
                        <label for="email1">Facultad</label>
                        <InputText id="email1" type="text" />
                        <small>Este Campo es Requerido.</small>
                    </div>
                    <div class="flex flex-col gap-2">
                        <label for="age1">Programa Académico</label>
                        <InputText id="age1" type="text" />
                        <small>Este Campo es Requerido.</small>
                    </div>
                    <div class="flex flex-col gap-2">
                        <label for="age1">Recursos Necesarios</label>
                        <InputText id="age1" type="text" />
                        <small>Este Campo es Requerido.</small>
                    </div>
                    <div class="flex flex-wrap">
                        <label for="address">Justificación de la necesidad de la práctica y recursos</label>
        ...
        <div class="flex mt-8">
            <div class="card flex flex-col gap-4 w-full">
                ...
                <div class="flex flex-col md:flex-row gap-4">
                    ...
                    <div class="flex flex-wrap gap-2 w-full">
                        <label for="lastname2">nuevo campo</label>
                        <InputText id="lastname2" type="text" />
                    </div>
                </div>
